...
return array(
  ...
  //忘记密码
  '_fotgotpsw_title' => 'forget password ',
  '_fotgotpsw_1' => 'please enter mnemonic ',
  '_fotgotpsw_2' => 'please enter username ',
  '_fotgotpsw_3' => 'please enter new password ',
  '_fotgotpsw_4' => 'confirm ',
  '_fotgotpsw_5' => 'enter new password again ',
  '_fotgotpsw_6' => 'confirm ',
  '_fotgotpsw_7' => 'please enter mnemonic ',

  // 朋友
  'friend0'=>'Please enter the search content',
  'friend1'=>'search',
  
  // 发现
  '_find_1' => 'fun',
  '_find_2' => 'business school',
  '_find_3' => 'customer service',
  '_find_4' => 'financial report',
  '_find_5' => 'recruit',
  '_find_6' => 'reception center',
  '_find_7' => 'activity',
 ...
 '_footer_4' => 'my',
  ...
  // 我的-主页
  'my_index0'=>'recommender',
  'my_index1'=>'wallet',
  'my_index2'=>'team',
  'my_index3'=>'revenue',
  'my_index4'=>'Promote Lock Powder',
  'my_index5'=>'I want to return the bill',
  'my_index6'=>'modify the fund password',
  'my_index7'=>'safe exit',
  'my_index8'=>'release record',

  // 登录
  'login0'=>'login account',
  'login1'=>'Please enter a username',
  'login2'=>'Please enter your login password',
  'login3'=>'login',
  'login4'=>'Register now',
  'Login5'=>'Forget the password',
  // 注册
  '_register0'=>'Create Account',
  '_register1'=>'6-20 user names',
  '_register9'=>'8-12-bit password',
  '_register2'=>'Confirm password',
  '_register3'=>'6-digit payment password',
  '_register4'=>'Confirm password',
  '_register5'=>'Enter the recommendation code',
  '_register6'=>'Next step',
  '_register7'=>'Legal Statement + User Agreement',
  '_register8'=>'Return to login',
  '_register10'=>'Registration Check Successful',
  '_register11'=>'failed registration validation',
  '_register12'=>'backup mnemonic',
  '_register13'=>'input mnemonic',
  '_register14' => 'Please enter your new payment password',
  '_register15' => 'password error',
  '_register16' => 'password changed successfully',
  '_register17'=> 'verification code',
  // 备份助记词
  'remember0'=>'mnemonic will be used to restore or reset the walletpassword',
  'remember1'=>'If your mnemonic is acquired by others, your property may be damaged',
  'remember2'=>"Don't take screenshots or send them to others",
  'remember3'=>'Recommends reading and reciting the full text, or copying and placing it in a safe place',
  'remember4'=>'Please click the mnemonic in order to verify the correctness of the backup',
  'remember 5'=>'complete backup',
  //在线客服
'_online_online' => 'online',
'_online_1' => 'FAQ ',
'_online_2' => '1. How many types of registered accounts are there?',
'_online_3' => 'registered accounts are divided into three categories, class A (junior broker) class B (intermediate broker) class C (senior broker) ',
'_online_4' => '2. How much is the static reward for registered account?',
'_online_5' => 'class A static dividend reward 4 times, class B dividend reward 4.5 times, class C dividend reward 5 times ',
'_online_6' => 'problem commit ',
'_online_7' => 'please fill in the question details here, and then submit ',
'_online_8' => 'confirm commit ',
  // 钱包
  'wallet0'=>'wallet',
  'wallet1'=>'investment',
  'wallet2'=>'has been paid a dividend:',
  'wallet3'=>'balance',
  'wallet4'=>'Bill of lading',
  'wallet5'=>'coinage',
  'wallet6'=>'withdrawal',
  'wallet7'=>'Bonus pools:',
  'wallet8'=>'Recast',
  'wallet9'=>'Lottery code:',
  'wallet10'=>'roll-out',
  'wallet11'=>'mall:',
  'wallet12'=>'Can release',
  // 团队
  'Team0'=>'Team',
  'team1'=>'total number',
  'team2'=>'person',
  'team3'=>'user ID',
  'team4'=>'Three generations',
  'team5'=>'Two generations',
  'Team6'=>'One generations',
  'team7'=>'level:',
  'team8'=>'member',
  // 收益
  'profit0'=>'revenue',
  ...
  'profit3'=>"yesterday",
  'profit4'=>'cumulative',
  'profit5'=>'direct push award',
  'profit6'=>'Share Award',
  'profit7'=>'Team Service Award',
  'profit8'=>'has been paid a dividend',
  'profit9'=>"Yesterday's dividend",
  'profit10'=>'dividend details',
  // 投单
  'toudan0'=>'billing',
  'toudan1'=>'investment amount',
  'toudan2'=>'capital password',
  'toudan3'=>'* instructions for placing orders',
  'toudan4'=>'Dear investors, any financial project has certain risks, and national group may go bankrupt due to some irresistible factors, resulting in insolvency.If one day in the future, the group can not continue to operate, we will gradually repay the principal according to the realization of the assets, until the assets sold until clean.If the sale of all assets after the principal is not completely repay, please forgive me, please bear the corresponding loss.',
  'toudan5'=>'confirmation of the order',
  'toudan6' => 'record',
  'toudan7 '=>    'interval (USDT)',
    'toudan8' => 'please enter valid amount ',
    
  //投单订单记录
  '_toudanlist_1'=> 'type ',
'_toudanlist_2'=> 'successful ',
'_toudanlist_3'=> 'amount ',
'_toudanlist_4'=> 'no purchase record ',
'_toudanlist_5'=> 'order ',
'_toudanlist_6'=> 'no record yet ',
'_toudanlist_7'=> 'return type ',
'_toudanlist_8'=> 'amount ',
'_toudanlist_9'=> 'provider ',
'_toudanlist_10'=> 'bonus',

  // 提币
  'tibi0'=>'withdrawal',
  'tibi1'=>'address:',
  'tibi2'=>'paste your wallet address',
  'tibi3'=>'amount:',
  'tibi4'=>'The handling fee for withdrawing money is two thousandths',
  'tibi5'=>'confirm transfer',
  'tibi6'=>'address error',
  'tibi7'=>'Cash withdrawal input is wrong, please re-enter',
  'tibi8'=>'Please enter the fund password',
  'tibi9'=>'OK',
  'tibi10'=>'cancel',
  'tibi11'=>'You have successfully withdrawn',
  'tibi12'=>'Please note the account',
  'tibi12'=>'record',
  'tibi13'=>'enter the amount of withdrawals',
  'tibi14'=>'* Notes for withdrawal of coins',
  'tibi15' => 'The name',
  'tibi16' => 'please enter your real name ',
'tibi17' => 'mobile number ',
'tibi18' => 'please enter phone number ',
   ...
   'You are already a Super Platform User. Do not repeat your application'=>"You are already a Super Platform User. Do not repeat your application",
    ...
    'register6' => 'verification code failed ',
    'register7' => 'user name already exists ',
    'register8' => 'recommended code error ',

    'mnemonic0' => 'Backup mnemonic',
    'mnemonic1' => 'The mnemonic will be used to restore the walletor reset the password.',
    ...
    //充值
    'Top up' => ' Top up',
    'ins' => 'The walletaddress is forbidden to recharge other currencies, and any abnormal recharge will not be recovered. The consequences are at your own risk.',
    ...
    '_recharge_title' => 'USDT Recharge',
    '_recharge_1' => 'address:',
    '_recharge_2' => 'copy',
    '_recharge_3' => '* the wallet address prohibits recharge in other currencies, and any abnormal recharge will not be recovered ',
    '_recharge_4' => 'replication successful ',
    '_recharge_5' => 'record',
    
    //复投
    '_formft_title' => 'reinvestment ',
    '_formft_1' => 'Amount:',
    '_formft_2' => '* notice to order ',
    '_formft_3' => 'pre-investment please recharge USDT,1000USDT initial investment, please invest carefully ',
    '_formft_4' => 'confirm reinvestment ',
    //博彩码转出
    '_formbcmzc_title' => 'Ticket code out',
    '_formbcmzc_1' => 'address: ',
    '_formbcmzc_2' => 'paste the address ',
    '_formbcmzc_3' => 'amount: ',
    '_formbcmzc_4' => 'please enter amount ',
    '_formbcmzc_5' => '* roll-out instructions ',
    '_formbcmzc_6' => 'roll-out is irreversible, please fill in the address carefully ',
    '_formbcmzc_7' => 'Confirm roll-out ',
    //提币记录
    '_recordlist_title' => 'withdrawal record ',
    '_recordlist_1' => 'wallet address: ',
    '_recordlist_2' => 'withdrawal successful ',
    '_recordlist_4' => 'in review ',
    '_recordlist_5' => 'withdrawal failed ',
    '_recordlist_3' => 'no withdrawal record ',
    //推广
    '_tuiguang_1' => 'Scan code registration',

    //消费码转出
    '_formxfmzc_title' => 'transferred out',
    '_formxfmzc_1' => 'address: ',
    '_formxfmzc_2' => 'paste the address here ',
    '_formxfmzc_3' => 'amount: ',
    '_formxfmzc_4' => 'please enter amount ',
    '_formxfmzc_5' => '* roll-out instructions ',
    '_formxfmzc_6' => 'roll-out is irreversible, please fill in the address carefully ',
    '_formxfmzc_7' => 'confirmation rollout',

    //退单
    '_tuidan_title' => 'return order',
    '_tuidan_1' => 'total investment：',
    '_tuidan_2' => 'released：',
    '_tuidan_3' => 'has been awarded：',
    '_tuidan_4' => 'penalty：',
    '_tuidan_5' => 'refundable amount：',
    '_tuidan_6' => 'confirm roll-out',

    //修改支付密码
    '_changepaypassword_title' => 'change payment password ',
'_changepaypassword_1' => 'please enter mnemonic ',
'_changepaypassword_2' => 'please enter 6 digits current password ',
'_changepaypassword_3' => 'please enter new password ',
'_changepaypassword_4' => 'enter new password again ',
'_changepaypassword_5' => 'confirm ',
    //弹窗
    '_layer_1' => 'fund password ',
    '_layer_2' => 'please enter password ',
    '_layer_3' => 'ok ',
    '_layer_4' => 'cancel ',
    ...
    'bank10'=>'immediate binding',
     ...
     //申请超级平台
    'Tips' => 'Tips',
    'To apply for joining bitcoin' => 'To apply for joining the Super Platform, you need to pay 1 Bitcoin Your orgital asset walletmust holo one and more than none bitcoin',
    'Return' => 'Return',
   ...
   // 现货交易二级界面
    ...
    'helpCotent4' => 'Simply speaking, digital money walletis actually the application of managing digital money based on block chain technology, such as Bitcoin. It is a management container of key (including private key and public key). It generally provides the functions of creating walletaddress, transferring money, transaction query and so on.',
    ...
    'helpCotent9' => 'Select the currency to recharge in the walletinterface, click on the recharge, it will show the recharge address, replicate the recharge address in other coin-holding platforms recharge corresponding currency, you can also sweep code recharge.<br>Note: The currency to be recharged should be the same as the actual currency, otherwise the currency will not be recovered. If you want to recharge Bitcoin, it will be recharged in Taifang, which will result in the loss of currency and can not be recovered. Please operate cautiously.',
    'helpCotent10' => 'The withdrawal can be made by selecting the currency to be withdrawn at the walletinterface, entering the number and address to be withdrawn, and clicking on the confirmation of the withdrawal and entering the password to withdraw.',
