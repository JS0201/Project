...
class AdminController2 extends CommonController {

    public function _initialize() {
        define('IN_ADMIN', TRUE);
        parent::_initialize();

        $this->admin_service = D('Admin/Admin', 'Service');
        ...
        if (!$admin_info) {
            ...
            showmessage('请先登录后台管理', U('admin/login/index'));
        }
...
//		if($admin_info['group_id'] > 0 && $this->admin_service->auth($admin_info['rules']) === false) {
