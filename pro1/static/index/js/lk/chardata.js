...
$('.period-widget').click(function(){
    ...
    var yuqi = (( (order_shouyi*0.01*order_price)*1000000000+order_price*1000000000) /1000000000);
    $('#yuqi').html(yuqi)
...
function endtimes() {
    ...
    console.log(yuce_case);
    yuce_case = Math.round(yuce_case*1000000)/1000000;
    $('.yuce').html(yuce_case+'币');
    ...
    $.get(tourl,function(resdata){
        if(resdata){
            ...
            if(resdata.is_win == 1){
                ...
                var _ploss = (resdata.ploss*100000000+resdata.fee*100000000)/100000000;
                $('.result_profit').html(_ploss+'币');
                ...
                $('.result_profit').html(resdata.ploss*100000000/100000000+'币');
            ...
            html += '<li ng-repeat="o in trade_order_list" class="">\
                        <section>\
                            <p style="margin: 0">\
                                ...
                                <span class="ng-binding '+ostyle_class2+'"><i class="'+ostyle_class+'"></i>'+ostyle_name+'（'+v.fee+'币）</span>\
                            </p>\
