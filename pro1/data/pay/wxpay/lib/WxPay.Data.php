...
class WxPayRefund extends WxPayDataBase
{
	...
	**/
	...
	/**
	* 设置退款总金额，订单总金额，链为分，只能为整数，详见支付金额
	* @param string $value 
	**/
	...
	/**
	* 获取退款总金额，订单总金额，链为分，只能为整数，详见支付金额的值
	* @return 值
	**/
	...
	/**
	* 判断退款总金额，订单总金额，链为分，只能为整数，详见支付金额是否存在
	* @return true 或 false
	**/
