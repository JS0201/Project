...
return [
    ...
    'userphone_not_exist' => '手机号不能为空',
    'userphone_error' => '手机号不正确',
    ...
    'admin_log_site_default' => '系统管理',
    'admin_log_edit_site' => '修改配置',
    'admin_log_site_weixin' => '微信管理->微信配置',
    'admin_log_site_weixin_reply' => '微信管理->系统回复',
    'admin_log_site_base' => '系统管理->系统设置',
    'admin_log_site_shop' => '系统管理->商店设置',
    'admin_log_site_member' => '系统管理->会员设置',
    'admin_log_site_safe' => '系统管理->安全配置',
    'admin_log_site_performance' => '系统管理->性能配置',
    'admin_log_site_performance' => '系统管理->性能配置',
    'admin_log_site_admin_user' => '系统管理->团队设置',
    'admin_log_site_add_admminuser' => '添加团队',
    'admin_log_site_edit_admminuser' => '编辑团队',
    'admin_log_site_delete_admminuser' => '删除团队',
    'admin_log_site_admin_group' => '系统管理->角色设置',
    'admin_log_site_add_admmingroup' => '添加角色',
    'admin_log_site_edit_admmingroup' => '编辑角色',
    'admin_log_site_delete_admmingroup' => '删除角色',
    'admin_log_site_admin_database' => '系统管理->数据库',
    'admin_log_site_optimize_database' => '优化数据库',
    'admin_log_site_repair_database' => '修复数据库',
    'admin_log_site_export_database' => '数据库备份',
    'admin_log_site_download_database' => '下载数据库备份文件',
    'admin_log_site_district' => '系统管理->地区管理',
    'admin_log_site_add_district' => '添加地区',
    'admin_log_site_edit_district' => '编辑地区',
    'admin_log_site_delete_district' => '删除地区',

    'admin_log_content' => '站点管理->内容管理',
    'admin_log_content_edit' => '编辑内容',
    'admin_log_content_add' => '添加内容',
    'admin_log_content_delete' => '删除内容',
    'admin_log_content_category' => '站点管理->内容分类',
    'admin_log_content_add_category' => '添加分类',
    'admin_log_content_edit_category' => '编辑分类',
    'admin_log_content_delete_category' => '删除分类',
    'admin_log_ads' => '站点管理->广告管理',
    'admin_log_ads_add' => '添加广告',
    'admin_log_ads_edit' => '编辑广告',
    'admin_log_ads_delete' => '删除广告',
    'admin_log_ads_add_position' => '添加广告位置',
    'admin_log_ads_edit_position' => '编辑广告位置',
    'admin_log_ads_delete_position' => '删除广告位置',
    'admin_log_goods' => '商品管理->商品管理',
    'admin_log_goods_add' => '添加商品',
    'admin_log_goods_edit' => '编辑商品',
    'admin_log_goods_delete' => '删除商品',
    'admin_log_goods_category' => '商品管理->商品分类',
    'admin_log_goods_add_category' => '添加商品分类',
    'admin_log_goods_edit_category' => '编辑商品分类',
    'admin_log_goods_delete_category' => '删除商品分类',
    'admin_log_goods_brand' => '商品管理->商品品牌',
    'admin_log_goods_add_brand' => '添加商品品牌',
    'admin_log_goods_edit_brand' => '编辑商品品牌',
    'admin_log_goods_delete_brand' => '删除商品品牌',
    'admin_log_goods_spec' => '商品管理->商品规格',
    'admin_log_goods_add_spec' => '添加商品规格',
    'admin_log_goods_edit_spec' => '编辑商品规格',
    'admin_log_goods_delete_spec' => '删除商品规格',
    'admin_log_order' => '订单管理->订单管理',
    'admin_log_order_delivery' => '订单发货',
    'admin_log_order_cancel' => '取消订单',
    'admin_log_order_recycle' => '废弃订单',
    'admin_log_order_finish' => '确认订单完成',

    'admin_log_member' => '会员管理->会员管理',
    'admin_log_member_add' => '添加会员',
    'admin_log_member_edit' => '编辑会员',
    'admin_log_member_delete' => '删除会员',
    'admin_log_member_group' => '会员管理->会员等级',
    'admin_log_member_add_group' => '添加会员等级',
    'admin_log_member_edit_group' => '编辑会员等级',
    'admin_log_member_delete_group' => '删除会员等级',
    'admin_log_member_recharge' => '会员管理->充值管理',
    'admin_log_member_edit_recharge' => '修改充值状态',
    'admin_log_member_delete_recharge' => '删除充值记录',
    'admin_log_member_edit_recharge_1' => '审核中',
    'admin_log_member_edit_recharge_2' => '充值成功',
    'admin_log_member_edit_recharge_3' => '充值失败',
    'admin_log_member_withdraw' => '会员管理->提现管理',
    'admin_log_member_edit_withdraw' => '修改提现状态',
    'admin_log_member_delete_withdraw' => '删除提现记录',
    'admin_log_member_edit_withdraw_1' => '审核中',
    'admin_log_member_edit_withdraw_2' => '提现成功',
    'admin_log_member_edit_withdraw_3' => '提现失败',

    'admin_log_weixin_menu' => '微信管理->自定义菜单',
    'admin_log_weixin_add_menu' => '添加自定义菜单',
    'admin_log_weixin_edit_menu' => '编辑自定义菜单',
    'admin_log_weixin_delete_menu' => '删除自定义菜单',

    'admin_log_notify' => '模块管理->通知管理',
    'admin_log_notify_edit' => '修改通知管理',
    'admin_log_pay' => '模块管理->支付管理',
    'admin_log_pay_edit' => '修改支付管理',
    'admin_log_app' => '模块管理->系统模块',
    'admin_log_app_edit' => '修改系统模块',
    ...
    'money_abnormal'                  => '用户积分余额异常',
    'money_not_enough'                => '积分余额不足',
    ...
    //**************************文字模版*****************************
    'exception_log'                           => '购物积分余额数据异常，停止给此会员执行累加购物积分动作！',
    'pay_log_text'                            => '订单付款，订单号：'
