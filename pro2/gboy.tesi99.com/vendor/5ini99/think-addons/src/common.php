...
// 插件目录
define('ADDON_PATH', ROOT_PATH . 'public/plugins' . DS);

// 定义路由
Route::any('plugins/execute/:route', "\\think\\addons\\Route@execute");
...
// 注册类的根命名空间
Loader::addNamespace('plugins', ADDON_PATH);
...
function addon_url($url, $param = [], $suffix = true, $domain = false)
{
    ...
    return url("plugins/execute/{$actions}", $param, $suffix, $domain);
}